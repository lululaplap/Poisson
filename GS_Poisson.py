...
class GS(Poisson):
    def __init__(self,N,phi,rho):
        ...
        self.phi = np.pad(self.phi,((1,2),(1,2),(1,2)),'constant',constant_values=((0,0),(0,0),(0,0)))
        self.rho = np.pad(self.rho,((1,2),(1,2),(1,2)),'constant',constant_values=((0,0),(0,0),(0,0)))
        ...
        for i in range(self.N):
            for j in range(self.N):
                for k in range(self.N):
                    self.phi[i,j,k] = 1/6.0*(self.phi[(i+1),j,k]+self.phi_next[(i-1),j,k] \
